...
namespace AdminPersonal.Pages.Puestos
{
    public class CreateModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            // Validar que el código no exista previamente en la base de datos
            var exist = MemoryPuestoRepository.GetAll().Any(p => p.Codigo.Equals(Puesto.Codigo, System.StringComparison.OrdinalIgnoreCase));
            if (exist)
            {
            ...
            MemoryPuestoRepository.Add(Puesto);
